...
struct CIEColorMatchingFunction
{
    static constexpr int minWavelengthInNanometers = 390;
    static constexpr int maxWavelengthInNanometers = 830;
    ...
    static constexpr int constexprCeil(float v) noexcept
    {
        return v < 0 ? static_cast<int>(v) : -static_cast<int>(-v);
    }
